...
// Después de registrar la salida del stock, redirige a la página de pago o al proceso de finalización de la compra
// Cambia '/checkout' por la ruta adecuada para el proceso de pago
  return (
    <div className={style.overallDetail}>
      ...
      <div className={style.summingTotal}>
        ...
        <div className={style.button}>
          <input type="submit" value="Elige tu Método de Pago" onClick={exitStock} />
        </div>
      </div>
    </div>
  );
